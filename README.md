...
I enjoy designing and developing **scalable web applications, AI-powered tools, SaaS platforms, enterprise software and practical technology products** using modern software engineering practices.
...
* ☁️ Cloud Technologies & REST APIs
* 🔐 Secure Software & Cybersecurity
* 🗄️ Database Architecture
* 🧩 Product Engineering & System Design

I believe in **continuous learning, innovation and building products that create meaningful impact**. Every project is an opportunity to learn, improve and create technology that solves real problems.
